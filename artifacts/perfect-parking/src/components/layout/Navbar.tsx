      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center">
            <button 
              onClick={() => {
                trackEvent("cta_click", { cta_label: "Get a Free Estimate", source_page: location || "/", cta_location: "navbar_desktop" });
                openContactModal();
              }}
          ...
          >
            <div className="flex flex-col px-4 py-6 gap-4">
              ...
              <div className="pt-4 border-t border-border">
                <button 
                  onClick={() => {
                    trackEvent("cta_click", { cta_label: "Get a Free Estimate", source_page: location || "/", cta_location: "navbar_mobile" });
                    openContactModal();
                  }}
