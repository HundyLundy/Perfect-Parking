...
const faqs = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "There are no upfront fees, no hardware costs, and no monthly minimums. We operate on a revenue share model — we only earn when you earn. The exact split is disclosed during your free estimate and depends on your property type, volume, and services required."
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: "What does a free parking revenue estimate include?",
        a: "Our free estimate includes a satellite-based review of your property, a revenue projection based on your space count and market rate, a customized monetization plan, and a 15-minute call to walk you through the numbers. There's no commitment required."
      },
      {
      ...
      },
      {
        ...
        a: "Request your free revenue estimate at perfectparking.com. We'll review your property, model your revenue potential, and schedule a quick call to share the numbers. If it makes sense for both parties, we move forward — on your timeline."
      }
    ]
  }
];
