    ...
    <>
      ...
      <section className="py-20 bg-muted border-t border-border text-center">
        <div className="max-w-2xl mx-auto px-4">
          ...
          <p className="text-muted-foreground text-lg mb-8">Book a free 15-minute audit and we'll show you the numbers.</p>
          <button
          ...
          >
            Book a Free Audit <BookOpen className="w-5 h-5" />
          </button>
        </div>
      </section>
    </>
